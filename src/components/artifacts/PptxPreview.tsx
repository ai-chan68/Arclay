 ...
 *
 * PowerPoint presentation preview with JSZip XML parsing
 */
...
import type { PptxSlide, PreviewComponentProps } from '../../shared/types/artifacts';
import { isRemoteUrl, MAX_PREVIEW_SIZE, openFileExternal } from '../../shared/lib/file-utils';
    ...
    <div className="flex h-full flex-col bg-muted/30">
      ...
      <div className="relative flex flex-1 items-center justify-center overflow-hidden p-4">
        ...
        <button
          ...
          className={cn(
            'absolute left-4 z-10 flex h-10 w-10 items-center justify-center rounded-full transition-all',
        ...
        <button
          ...
          className={cn(
            'absolute right-4 z-10 flex h-10 w-10 items-center justify-center rounded-full transition-all',
            'bg-background/80 hover:bg-background shadow-lg',
            'disabled:cursor-not-allowed disabled:opacity-30'
          )}
        >
        ...
        {/* Slide content */}
        <div className="relative aspect-[16/9] w-full max-w-4xl overflow-hidden rounded-lg bg-white shadow-xl">
          {slide.imageUrl ? (
            // Slide with image
